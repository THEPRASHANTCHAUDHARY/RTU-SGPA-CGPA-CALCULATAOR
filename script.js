...
const data = {
    CSE: {
        ...
        sem3: [
            ...
            { name: "Advanced Engineering Mathematics", credit: 1 },
            { name: "Digital Electronics", credit: 4 },
            { name: "Data Structure & Algorithms", credit: 4 },
            { name: "Object Oriented Programming", credit: 1 },
            { name: "Software Engineering", credit: 2 },
            { name: "Data Structure & Algorithm Lab", credit: 2 },
            ...
            { name: "Industrial Training", credit: 0.5 },
            { name: "Financial Literacy", credit: 0.5 }
        ],
        sem4: [
            { name: "Technical Comunication", credit: 2 },
            { name: "Discrete Mathematics Structure", credit: 1 },
            { name: "Microprocessor & Interfaces", credit: 4 },
            { name: "Database Management System", credit: 4 },
            { name: "Theory of Computation", credit: 1 },
            { name: "Data Communication and Computer Networks", credit: 2 },
            { name: "Microprocessor & Interfaces Lab", credit: 2 },
            { name: "Database Management System Lab", credit: 1.5 },
            { name: "Network Programming Lab", credit: 1 },
            { name: "Linux Shell Programming Lab", credit: 1.5 },
    ...
    IT: {
        sem1: [
            { name: "Human Values", credit: 2 },
            { name: "Human Values Activities & Sports", credit: 2 },
            { name: "Engineering Mathematics-II", credit: 4 },
            { name: "Engineering Chemistry", credit: 4 },
            { name: "Engineering Chemistry Lab", credit: 2 },
            { name: "Basic Mechanical Engineering", credit: 4 },
            { name: "Basic Civil Engineering", credit: 4 },
            { name: "Manufacturing Practices Workshop", credit: 2 },
            { name: "Basic Civil Engineering Lab", credit: 2 },
            { name: "Sports II", credit: 2 }
        ],
        sem2: [
            { name: "Communication Skills", credit: 2 },
